...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('offering_letters', function (Blueprint $table) {
            ...
            $table->foreignId('hr_signer_id')->constrained('users')->restrictOnDelete();
            ...
            $table->text('hr_signing_url')->nullable();
            $table->text('candidate_signing_url')->nullable();
            $table->enum('status', ['draft', 'sent', 'viewed', 'negotiation', 'accepted', 'rejected', 'expired', 'signed'])->default('draft')->index();
